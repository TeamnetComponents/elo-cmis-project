...
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_COUNTRY = "elo.connection.factory.connection.server.country";
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_LANGUAGE = "elo.connection.factory.connection.server.language";
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_TIMEZONE = "elo.connection.factory.connection.server.timeZone";
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_COUNTRY_DEFAULT = "US";
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_LANGUAGE_DEFAULT = "en";
//    public static final String ELO_CONNECTION_FACTORY_CONNECTION_SERVER_TIMEZONE_DEFAULT = "";
//
//
...
//
////    public IXConnFactory createIXConnFactory() throws de.elo.utils.net.RemoteException {
////        return createIXConnFactory(eloCmisConnectionManager.getCmisServiceParameters());
////    }
//
//    public static IXConnFactory createIXConnFactory(CmisServiceParameters cmisServiceParameters) throws de.elo.utils.net.RemoteException {
//        IXConnFactory ixConnFactory = null;
//        // set connection properties
//        String url = cmisServiceParameters.getStringParameter(ELO_CONNECTION_FACTORY_PROPERTY_URL, "");
//        int nbOfCnns = cmisServiceParameters.getIntegerParameter(ELO_CONNECTION_FACTORY_PROPERTY_NB_OF_CNNS, 0);
//        int timeoutSeconds = cmisServiceParameters.getIntegerParameter(ELO_CONNECTION_FACTORY_PROPERTY_TIMEOUT_SECONDS, 0);
//        Properties connectionProperties = IXConnFactory.createConnProps(url, nbOfCnns, timeoutSeconds);
//
//        // set session options
//        String appName = cmisServiceParameters.getStringParameter(ELO_CONNECTION_FACTORY_SESSION_APP_NAME, "Application Name");
//        String appVersion = cmisServiceParameters.getStringParameter(ELO_CONNECTION_FACTORY_SESSION_APP_VERSION, "Application Version");
//        Properties sessionOptions = IXConnFactory.createSessionOptions(appName, appVersion);
//
//        //create and return IXConnectionFactory object
//        ixConnFactory = new IXConnFactory(connectionProperties, sessionOptions);
